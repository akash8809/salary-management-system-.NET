...
Partial Public Class empDataSet1
    ...
    Partial Public Class EMP_DETAILSDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEMP_DETAILSRow(ByVal EMP_ID As Integer, ByVal FIRSTNAME As String, ByVal LASTNAME As String, ByVal ADDRESS As String, ByVal CONTACT_NO As String, ByVal EMAIL As String, ByVal DOB As Date, ByVal AGE As Integer, ByVal EDUCATION As String, ByVal DESIGNATION As String, ByVal GENDER As String) As EMP_DETAILSRow
            Dim rowEMP_DETAILSRow As EMP_DETAILSRow = CType(Me.NewRow,EMP_DETAILSRow)
            Dim columnValuesArray() As Object = New Object() {EMP_ID, FIRSTNAME, LASTNAME, ADDRESS, CONTACT_NO, EMAIL, DOB, AGE, EDUCATION, DESIGNATION, GENDER}
    ...
    Partial Public Class EMP_DETAILSTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[EMP_DETAILS] WHERE (([EMP_ID] = @Original_EMP_ID) AND ([FIRSTN"& _ 
                ...
                " = @Original_ADDRESS) AND ([CONTACT_NO] = @Original_CONTACT_NO) AND ([EMAIL] = @"& _ 
                "Original_EMAIL) AND ([DOB] = @Original_DOB) AND ([AGE] = @Original_AGE) AND ([ED"& _ 
                "UCATION] = @Original_EDUCATION) AND ([DESIGNATION] = @Original_DESIGNATION) AND "& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[EMP_DETAILS] ([EMP_ID], [FIRSTNAME], [LASTNAME], [ADDRESS], [C"& _ 
                "ONTACT_NO], [EMAIL], [DOB], [AGE], [EDUCATION], [DESIGNATION], [GENDER]) VALUES "& _ 
                "(@EMP_ID, @FIRSTNAME, @LASTNAME, @ADDRESS, @CONTACT_NO, @EMAIL, @DOB, @AGE, @EDU"& _ 
                "CATION, @DESIGNATION, @GENDER);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT EMP_ID, FIRSTNAME, LASTNAME, ADDRESS, CO"& _ 
                "NTACT_NO, EMAIL, DOB, AGE, EDUCATION, DESIGNATION, GENDER FROM EMP_DETAILS WHERE"& _ 
                " (EMP_ID = @EMP_ID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[EMP_DETAILS] SET [EMP_ID] = @EMP_ID, [FIRSTNAME] = @FIRSTNAME, [LAS"& _ 
                "TNAME] = @LASTNAME, [ADDRESS] = @ADDRESS, [CONTACT_NO] = @CONTACT_NO, [EMAIL] = "& _ 
                "@EMAIL, [DOB] = @DOB, [AGE] = @AGE, [EDUCATION] = @EDUCATION, [DESIGNATION] = @D"& _ 
                "ESIGNATION, [GENDER] = @GENDER WHERE (([EMP_ID] = @Original_EMP_ID) AND ([FIRSTN"& _ 
                "AME] = @Original_FIRSTNAME) AND ([LASTNAME] = @Original_LASTNAME) AND ([ADDRESS]"& _ 
                " = @Original_ADDRESS) AND ([CONTACT_NO] = @Original_CONTACT_NO) AND ([EMAIL] = @"& _ 
                "Original_EMAIL) AND ([DOB] = @Original_DOB) AND ([AGE] = @Original_AGE) AND ([ED"& _ 
                "UCATION] = @Original_EDUCATION) AND ([DESIGNATION] = @Original_DESIGNATION) AND "& _ 
                "([GENDER] = @Original_GENDER));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT EMP_ID, FIRSTNAME, LASTNAME, ADDRESS, CO"& _ 
                "NTACT_NO, EMAIL, DOB, AGE, EDUCATION, DESIGNATION, GENDER FROM EMP_DETAILS WHERE"& _ 
                " (EMP_ID = @EMP_ID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT EMP_ID, FIRSTNAME, LASTNAME, ADDRESS, CONTACT_NO, EMAIL, DOB, AGE, EDUCATI"& _ 
                "ON, DESIGNATION, GENDER FROM dbo.EMP_DETAILS"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As empDataSet1.EMP_DETAILSDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As empDataSet1.EMP_DETAILSDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As empDataSet1.EMP_DETAILSDataTable = New empDataSet1.EMP_DETAILSDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As empDataSet1.EMP_DETAILSDataTable) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal EMP_ID As Integer, ByVal FIRSTNAME As String, ByVal LASTNAME As String, ByVal ADDRESS As String, ByVal CONTACT_NO As String, ByVal EMAIL As String, ByVal DOB As Date, ByVal AGE As Integer, ByVal EDUCATION As String, ByVal DESIGNATION As String, ByVal GENDER As String) As Integer
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_DESIGNATION As String,  _
                    ByVal Original_GENDER As String) As Integer
            Return Me.Update(Original_EMP_ID, FIRSTNAME, LASTNAME, ADDRESS, CONTACT_NO, EMAIL, DOB, AGE, EDUCATION, DESIGNATION, GENDER, Original_EMP_ID, Original_FIRSTNAME, Original_LASTNAME, Original_ADDRESS, Original_CONTACT_NO, Original_EMAIL, Original_DOB, Original_AGE, Original_EDUCATION, Original_DESIGNATION, Original_GENDER)
        End Function
    End Class
